...
test('disabled account remains projectable for admin lists',()=>{const u=publicAccount({account_id:'A2',username:'disabled',display_name:'Disabled',role:'FARMER',status:'disabled',permissions_json:{farm:'view',deck:'none',farmIds:['F1']},session_version:3});assert.equal(u.status,'disabled');assert.equal(u.version,3);});

...
const EXPECTED_START_VERSION=2;
...
if(baseVersion!==EXPECTED_START_VERSION)throw Error(`WRITE_VERIFIER_ALREADY_RAN_OR_STATE_CHANGED expected=${EXPECTED_START_VERSION} actual=${baseVersion}`);

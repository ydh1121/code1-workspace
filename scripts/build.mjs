...
for(const path of ['public/index.html','public/assets/app.js','public/assets/accounts.js','public/assets/farm-model.js','public/assets/question-help.js','public/assets/core.js','public/assets/RequestFont.ttf','functions/api/rpc.js','functions/api/accounts.js','functions/api/auth/password.js','bridge/CloudflareBridge.gs','bridge/AccessControl.gs','bridge/QuestionPolicy.gs'])await access(path);

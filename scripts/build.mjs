...
for(const path of ['public/index.html','public/assets/app.js','public/assets/farm-model.js','public/assets/core.js','public/assets/RequestFont.ttf','functions/api/rpc.js','bridge/CloudflareBridge.gs'])await access(path);

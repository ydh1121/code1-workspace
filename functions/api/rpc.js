...
const actions = new Set(['bootstrap','saveSubmission','getSubmission','review','upload','linkDrive','reviewMedia','media','deckAssets','saveDeck','settings']);
export async function onRequestPost({ request, env }) {
  try {
    ...
    return json({ data: await bridge(env, user.email, action, payload || {}) });

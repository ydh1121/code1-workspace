...
export function failure(e) {
  ...
  const known = { UNAUTHENTICATED: [401, '로그인 시간이 끝났거나 계정 권한이 변경되었습니다. 다시 로그인해 주세요.'], LOGIN_INVALID:[401,'아이디 또는 비밀번호를 확인해 주세요.'], LOGIN_THROTTLED:[429,'로그인 시도가 많습니다. 15분 후 다시 시도해 주세요.'], AUTH_SETUP_REQUIRED:[503,'최고 관리자의 최초 계정 설정이 필요합니다.'], BRIDGE_UPDATE_REQUIRED:[503,'관리자가 데이터 연결 파일을 업데이트해야 합니다.'], FORBIDDEN: [403, '허용된 계정과 작업 권한을 확인해 주세요.'], NOT_FOUND:[404,'요청한 항목을 찾을 수 없습니다.'], SETUP_REQUIRED: [503, '운영 연결 설정이 필요합니다. 관리자에게 알려주세요.'], BRIDGE_UNAVAILABLE: [502, '자료 저장소에 연결하지 못했습니다. 입력 내용은 이 창에 남아 있습니다.'], BUSY_RETRY: [409, '다른 저장이 진행 중입니다. 잠시 후 다시 저장해 주세요.'], DECK_WRITE_GATE_CLOSED:[503,'Deck 저장 전환 검증이 진행 중입니다. 읽기 전용 상태를 유지합니다.'], DECK_DRIVE_LINK_DISABLED:[503,'STAGING Deck에서는 기존 Drive 파일 연결을 사용하지 않습니다. 이미지는 직접 업로드해 주세요.'] };
